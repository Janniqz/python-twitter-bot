...
log = logging.getLogger('tweepy_video.cache')
...
class RedisCache(Cache):
    ...
    def __init__(self, client,
                 timeout=60,
                 keys_container='tweepy_video:keys',
                 pre_identifier='tweepy_video:'):
        Cache.__init__(self, timeout)
        self.client = client
    ...
    def store(self, key, value):
        ...
        # Prepend tweepy_video to our key,
        # this makes it easier to identify tweepy_video keys in our redis server
